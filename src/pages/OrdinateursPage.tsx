      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Découvrez notre gamme d'ordinateurs portables et de bureau reconditionnés
          </p>
        </div>
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-muted-foreground">Chargement des ordinateurs...</p>
          </div>
          ...
          <div className="text-center py-12">
            <h3 className="text-xl font-semibold mb-2">Aucun ordinateur trouvé</h3>
            <p className="text-muted-foreground mb-4">
              {hasActiveFilters 
                ? "Aucun ordinateur ne correspond à vos critères de recherche."
                : "Aucun ordinateur n'est disponible pour le moment."
              }
            </p>
            {hasActiveFilters && (
